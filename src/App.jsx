...
const App = () => {
  ...
  return (
    // 👇 Added id="app-scroll" so react-scroll knows which container to scroll
    <div className="app" id="app-scroll">
      <Cursor />
      <Navbar />
      
      {/* Each section is wrapped in Element with matching names */}
      <Element name="home">
